...
%% select channels
numChannel=[7 106 62 72 70 75 83 23 24 27 3 124 123 36 35 40 110 104 109 92 97 91 52 51 59];
...
N={'FR2', 'CZ1', 'FL1', 'FL3', 'FL5','CL3', 'CL1', 'CL5', 'PL5', 'PL1', 'PL3','PZC', 'O1', 'PZP', 'OZ', 'O2', 'PR4', 'PR2', 'PR6', 'CR2', 'CZ2', 'CR6', 'CR4', 'FR6', 'FR4'};
clear kk
...
EEG = pop_select(EEG, 'time', [1.4 4.75]);
eeglab redraw
