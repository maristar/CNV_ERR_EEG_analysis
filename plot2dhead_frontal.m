function plot2dhead_frontal(connectivity_measure, XYZ, B)
% 2-11-2011 for frontal lobe analysis
...
for k=1:length(B)
text(-XYZ(k,2), XYZ(k,1), B(k), 'FontSize',12, 'HorizontalAlignment', 'center','VerticalAlignment', 'bottom'); end

threshold=(10)*max(squeeze(max(squeeze(median(connectivity_measure)))));
